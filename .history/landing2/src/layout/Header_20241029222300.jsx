  ...
  return (
    <header className="text-white flex flex-col relative after:content-['']   after:absolute xl:after:w-[520px] xl:after:h-[520px] md:after:w-[300px] md:after:h-[300px] after:w-[200px] after:h-[200px] after:top-[90%] after:left-0 after:blur-[70px] after:rounded-full before:content-['']  before:absolute xl:before:w-[520px] xl:before:h-[520px] md:before:w-[300px] md:before:h-[300px] before:w-[200px] before:h-[200px] before:top-[60%] before:right-0 before:blur-[70px] before:rounded-full">
      <div className="max-w-[1320px] px-4 flex items-center justify-between py-[30px] mx-auto w-full relative">
        <div className="flex items-center gap-x-9">
          <Link
            ...
            className="max-w-[120px] lg:max-w-[120px] md:max-w-[120px]"
          >
            <img src={Icons.original_logo} alt="site logo" />
          </Link>
          <nav
          ...
          >
            ...
            >
              <li>
                <Link
                  to=""
                  className="font-semibold text-black text-base font-source-sans hover:opacity-90 transition-all ease-in-out duration-300 font-normal whitespace-nowrap"
                >
                  Features
                </Link>
              </li>
            ...
            <div className="flex flex-col gap-y-5 items-center lg:hidden mt-6">
              ...
              <button type="submit" className="text-black border-2 rounded-lg lg:min-h-[56px] min-h-[50px] text-nowrap text-base px-5 font-semibold hover:scale-105 transition-all ease-in-out duration-300">
              Request a demo
            </button>
            </div>
          </nav>
      ...
      <div className="flex flex-col items-center justify-center max-w-[1020px] mx-auto text-center font-montserrat flex-1 relative z-10 mt-[100px] px-4">
        ...
        <p className="lg:text-xl md:text-lg text-base my-[46px] text-black font-semibold">
        ...
        <form className="w-full">
          <div className="flex flex-col md:flex-row items-stretch gap-[14px] md:max-w-[610px] mx-auto">
            <input
              ...
              className="lg:min-h-[56px] min-h-[50px] px-4 rounded-lg bg-transparent border-[1px] border-black w-full placeholder:text-black outline-0 font-source-sans lg:text-base text-sm"
            />
            
            <button type="submit" className="text-black border-primary-2 rounded-lg lg:min-h-[56px] min-h-[50px] text-nowrap text-base px-5 font-semibold hover:scale-105 transition-all ease-in-out duration-300">
              Request a demo
            </button>
          </div>
        </form>
