  ...
  return (
    <header className="bg-dark-beige text-white flex flex-col relative after:content-['']   after:absolute xl:after:w-[520px] xl:after:h-[520px] md:after:w-[300px] md:after:h-[300px] after:w-[200px] after:h-[200px] after:top-[90%] after:left-0 after:blur-[70px] after:rounded-full before:content-['']  before:absolute xl:before:w-[520px] xl:before:h-[520px] md:before:w-[300px] md:before:h-[300px] before:w-[200px] before:h-[200px] before:top-[60%] before:right-0 before:blur-[70px] before:rounded-full">
        ...
        <div className="flex items-center gap-x-9">
          ...
          >
            ...
            <div className="flex flex-col gap-y-5 items-center lg:hidden mt-6">
              ...
              <Link
                to=""
                className="capitalize text-base font-semibold text-black transition-all duration-300 ease-in-out px-[30px] min-h-[44px] border-[1px] border-black border-solid rounded-lg inline-flex items-center justify-center text-center   whitespace-nowrap w-full"
              >
                log in
              </Link>
            </div>
      ...
      <div className="flex flex-col items-center justify-center max-w-[1020px] mx-auto text-center font-montserrat flex-1 relative z-10 mt-[100px] px-4">
        ...
        <p className="lg:text-xl md:text-lg text-base my-[46px] text-black">
