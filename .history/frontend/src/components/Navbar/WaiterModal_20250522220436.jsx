    ...
    <div className="modal-overlay-waiter" onClick={onClose}>
      <div className="modal-content-waiter" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="action-buttons">
          ...
          <span className="icon" aria-label="Logout" role="img">
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
    <path d="M6 12v-2h4V6H6V4l-4 4 4 4z"/>
    <path d="M11 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H8v-1h3V4H8V3h3z"/>
  </svg>
</span> {/* Iconă de ajutor */}
            {t('logout')}
          </button> : null}
        </div>
