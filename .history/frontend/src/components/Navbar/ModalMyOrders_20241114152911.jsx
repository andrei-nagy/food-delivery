...
const ModalMyOrders = ({ show, onClose }) => {
    ...
    return (
        <div className="modal-overlay-test" onClick={onClose}>
            <div className="modal-content-test" onClick={(e) => e.stopPropagation()}>
                <h2>My Orders</h2>
                {orders.length > 0 && (
                ...
                <button className="checkout-button" onClick={() => alert('Proceeding to checkout...')}>Pay</button>
            </div>
        </div>
    );
};
