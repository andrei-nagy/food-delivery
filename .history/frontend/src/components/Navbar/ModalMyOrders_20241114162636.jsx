            ...
            <div className="modal-content-myorders" onClick={(e) => e.stopPropagation()}>
                ...
                <div className='checkout-section'>
                    ...
                    <div className="payment-options">
                        {/* <img src={assets.visaLogo} alt="Visa" className="payment-option" /> */}
                        {/* <img src={assets.mastercardLogo} alt="Mastercard" className="payment-option" /> */}
                        <img src={assets.apple_pay} alt="Apple Pay" className="payment-option" />
                        {/* <img src={assets.googlePayLogo} alt="Google Pay" className="payment-option" /> */}
                    </div>
