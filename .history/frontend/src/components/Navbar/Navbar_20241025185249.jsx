...
import { Link, useNavigate, useLocation } from 'react-router-dom'; // Adaugă useLocation
...
const Navbar = ({ setShowLogin }) => {
  ...
  // Folosește useLocation pentru a verifica calea curentă
  const location = useLocation();
  const isWelcomePage = location.pathname === '/welcome'; // Verifică dacă suntem pe pagina de întâmpinare
  ...
  return (
    <div className="navbar">
      ...
      {/* Condiționează renderizarea navbar-right doar dacă nu suntem pe pagina de întâmpinare */}
      {!isWelcomePage && (
