...
// const ModalCart = ({ show, onClose, cartItems, food_list, checkoutHandler, url, removeFromCart }) => {
    const ModalCart = () => {

    const { show, onClose, cartItems, food_list, checkoutHandler, url, removeFromCart } = useContext(StoreContext);
