...
const Navbar = ({ setShowLogin }) => {
  ...
  return (
    ...
    <div className="mobile-footer-item" onClick={() => setMenu("menu")}>
      <img src={assets.menu_icon} alt="Menu Icon" />
      <span>Menu</span>
    </div>
    <div className="mobile-footer-item" onClick={() => navigate('/myorders')}>
      <img src={assets.order_icon} alt="Order Icon" />
      <span>Order</span>
    </div>
    <div className="mobile-footer-item" onClick={handleOpenModal}>
      <img src={assets.actions_icon} alt="Actions Icon" />
      <span>Actions</span>
    </div>
  </div>
      <ModalCart
