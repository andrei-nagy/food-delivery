...
const ModalMyOrders = ({ show, onClose }) => {
    ...
    const [isClosing, setIsClosing] = useState(false); // Stare pentru efectul de închidere
    const navigate = useNavigate();

        // Funcția de închidere cu efect fadeOut
        const handleClose = () => {
            setIsClosing(true); // Setăm stare la true pentru a activa fadeOut
            setTimeout(() => {
                onClose(); // Închidem modalul după efectul de fadeOut
            }, 500); // 500ms corespunde cu durata tranziției
        };
        ...
        <div className="modal-overlay-myorders" onClick={onClose}>
            <div className="modal-content-myorders" onClick={(e) => e.stopPropagation()}>
                <div className="header-myorders">
                    ...
                    <div className="close-menu-button-myorders" onClick={() => { navigate('/'); onClose(); }}>
                        <span></span>
