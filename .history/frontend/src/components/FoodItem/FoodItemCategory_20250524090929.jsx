...
const FoodItemCategory = ({ id, name, price, description, image, isBestSeller, isNewAdded, isVegan, category }) => {
    ...
    const openFoodModal = () => {
        ...
        // Setează cantitatea în modal la cantitatea din cartItems dacă există
        const currentQuantity = cartItems && cartItems[id] ? cartItems[id] : 1;
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-actions">
                            <div className="quantity-selector" onClick={e => e.stopPropagation()}>
                                {/* Folosim aceleași iconițe și comportament ca în card */}
                                <img
