...
const FoodItem = ({ id, name, price, description, image, isBestSeller, isNewAdded, isVegan, category, disableModal = false }) => {
...
`;
    ...
    return (
        <>
            <div
    className='food-item'
    onClick={!disableModal ? openFoodModal : undefined}
    style={{ cursor: disableModal ? 'default' : 'pointer' }}
>
