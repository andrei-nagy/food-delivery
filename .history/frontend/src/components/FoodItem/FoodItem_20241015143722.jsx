...
const FoodItem = ({ id, name, price, description, image }) => {
    ...
    const handleAddToOrder = () => {
        ...
        // addToCart(selectedFood.id, selectedQuantity); // Salvează cantitatea curentă
        closeFoodModal(); // Închide modalul
    };
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-actions">
                            <div className="quantity-selector">
                                ...
                                <button onClick={(e) => { e.stopPropagation(); addToCart(id, 1); handleIncreaseQuantity() }}>+</button>
                            </div>
                        </div>
                        ...
                        />
                        <button className="close" onClick={() => {handleAddToOrder(); addToCart(id, selectedQuantity);}}>Add to Order</button>
                    </div>
                </div>
            )}
        </>
