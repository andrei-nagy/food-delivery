...
import QuantityCounter from './QuantityCounter';  // import nou
                        ...
                        ? (
                            <div onClick={e => e.stopPropagation()}>
                                <QuantityCounter
                                    ...
                                    onIncrease={() => addToCart(id, 1)}
                                    onDecrease={() => removeFromCart(id, 1)}
                                />
                            </div>
                        ) : (
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-actions">
                            <QuantityCounter
                                ...
                                onIncrease={handleIncreaseQuantityModal}
                                onDecrease={handleDecreaseQuantityModal}
                            />
                        </div>
