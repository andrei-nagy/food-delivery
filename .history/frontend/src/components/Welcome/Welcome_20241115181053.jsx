    ...
    return (
        <div className="welcome-container">
            ...
            <div className="welcome-content">
                ...
                {/* <p>{data.slogan}</p> */}
                <p>
                To enhance your experience, scan the QR code to view the menu, place your order and relax. We are committed to providing you with the freshest dishes and an enjoyable dining experience!
