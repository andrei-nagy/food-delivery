...
const ThankYou = () => {
  ...
  useEffect(() => {
    ...
    const fetchRating = async () => {
      ...
      const url = `http://localhost:4000/api/order/${orderId}/rating`;
      console.log("Fetching rating from URL:", url); // Adaugă acest log
      const order = await orderModel.findById('670a35b473d430e90d642cc8');
      console.log(order);
      try {
