          ...
          <div className="cart-total">
            ...
            <div>
              ...
              <label className='label-payment-method'>
                <input className='payment-method ' type="radio" name="paymentMethod" value="creditCard" />
                Pay online with credit card
              </label>


              <label className='label-payment-method'>
                <input className='payment-method ' type="radio" name="paymentMethod" value="cashPOS" />
                Pay cash / POS
              </label>
            </div>
