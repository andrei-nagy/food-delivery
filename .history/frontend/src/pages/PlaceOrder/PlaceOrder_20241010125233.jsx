...
<!-- Option for paying online with a credit card -->
<label>
  <input type="checkbox" name="paymentMethod" value="creditCard" />
  Pay online with credit card
</label>

<!-- Option for paying with cash or POS -->
<label>
  <input type="checkbox" name="paymentMethod" value="cashPOS" />
  Pay cash / POS
</label>
</div>
