...
const addCustomization = async (req, res) => {
    ...
    const { restaurantName, backgroundImages, primaryColor, secondaryColor, slogan, contactEmail, contactPhone } = req.body;
...
const updateCustomization = async (req, res) => {
    ...
    try {
        ...
        const customization = await customizationModel.findOneAndUpdate(
            {}, // Aici ar trebui să fie un criteriu de căutare, de exemplu { restaurantId: req.params.restaurantId }
            {
                restaurantName,
                image,
                backgroundImages,
