...
const placeOrderCash = async (req, res) => {
    try {
        ...
        const newOrder = new orderModel({
            ...
            orderNumber: orderNumber,
            payment: false,
            paymentMethod: 'Cash / POS'   // Setăm comanda ca neplătită inițial (plata se face la livrare)
        });
...
const updatePaymentStatus = async (req, res) => {
    try {
        await orderModel.findByIdAndUpdate(req.body.orderId, { status: req.body.payment });
...
export { placeOrderCash, placeOrder, verifyOrder, userOrders, listOrders, updateStatus,updateOrderRating,getOrderRating, updatePaymentStatus }
