...
const createQRCode  = async (req, res) => {
    const { tableNo, restaurantId, qrImage, createdOn } = req.body;
...
const getQrCodes = async (req, res) => {
    try {
        ...
        const qrCodes = await qrCodeModel.findOne({ restaurantId });
...
export { registerAdmin, loginAdmin, updateCustomization, getCustomization, getAllAdminAccounts, removeAccount, updateAccount, createQRCode,getQrCodes  };
