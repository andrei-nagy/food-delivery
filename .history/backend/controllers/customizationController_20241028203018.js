...
const addCustomization = async (req, res) => {
    ...
    const { restaurantName, primaryColor, secondaryColor, slogan, contactEmail, contactPhone, deleteAccountHours, securityToken, openHour, closeHour, openingHours } = req.body;
...
const updateCustomization = async (req, res) => {
    const { id, restaurantName, primaryColor, secondaryColor, slogan, contactEmail, contactPhone, deleteAccountHours, securityToken, openHour, closeHour, openingHours } = req.body;
