...
const faqItems = [
  ...
  },
  {
    ...
    answer: `The most important features of Orderly are: customers can scan a QR code to view the menu, place orders, and pay directly through the app. Orders are instantly sent to the server’s admin panel in real-time for efficient management. The app saves time for both customers and staff while reducing errors. With an intuitive interface, Orderly boosts customer engagement, increases order frequency, and enhances the overall dining experience.`,
  },
  {
    id: 3,
