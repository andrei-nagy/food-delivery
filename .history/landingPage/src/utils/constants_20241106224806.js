...
const faqItems = [
  ...
  },
  {
    ...
    answer: `Orderly is designed for restaurant owners, managers, and staff who want to streamline their operations and enhance the customer experience. It is ideal for any type of restaurant, from small cafes to large dining establishments, looking to improve order management, speed up service, and increase efficiency. The app is also beneficial for customers who want a seamless and convenient way to place orders and pay directly from their smartphones.`,
  },
  {
    id: 6,
