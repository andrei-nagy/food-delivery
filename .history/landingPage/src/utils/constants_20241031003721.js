...
const faqItems = [
  {
    ...
    answer: `Getting started with Orderly is simple! Check out our latest features and sign up for a free trial.
     Once you begin using the Orderly platform, you’ll be able to set up your restaurant profile and customize your menu.
      Our user-friendly interface, along with step-by-step onboarding guides, will help you navigate all the features effortlessly. 
      Start transforming your dining experience today!`,
  },
  {
    id: 2,
    question: "What are the key features of SmartNotes?",
    answerHeading: "Orderly offers a range of powerful features designed to enhance your restaurant's operations and customer experience. Key features include:",
    answer: `QR Code Ordering: Customers can easily scan a QR code to access the menu, place orders, and make payments directly from their devices.

Real-time Management Dashboard: Managers can track sales, monitor inventory, and analyze customer data through an intuitive dashboard for better decision-making.

Menu Customization: Effortlessly update your menu items, prices, and categories in real-time to keep your offerings fresh and relevant.

Customer Insights: Gain valuable insights into customer preferences and behavior to tailor your services and promotions effectively.

Staff Management: Streamline staff scheduling and communication to enhance teamwork and improve service efficiency.

Customer Feedback: Collect and analyze customer feedback to continually improve the dining experience.`,
  },
  {
    id: 3,
