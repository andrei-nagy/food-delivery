...
const faqItems = [
  {
    ...
    answer: `Grderly is a powerful restaurant application designed to make the dining experience seamless for both customers and staff. With Orderly, customers simply scan a QR code to view the menu, place their order, and even pay directly from their phone, making the entire process quick and hassle-free. On the other side, orders are sent in real-time to the waitstaff’s admin panel, where they can instantly view and manage incoming requests. This streamlined approach not only enhances service speed and efficiency but also maximizes convenience for customers, encouraging them to order more with ease. Orderly saves time for everyone, creating a smooth, efficient experience from start to finish.`,
  },
  {
    id: 2,
