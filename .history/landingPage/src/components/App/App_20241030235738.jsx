  ...
  return (
    <Page>
      ...
      <Testimonial>
        ...
        Orderly offers a seamless, QR-powered dining experience, allowing guests to view menus and place orders effortlessly. For managers, Orderly provides robust data analytics and management capabilities, enhancing operational efficiency and business control.
        </h5>
