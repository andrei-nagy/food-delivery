...
const Navigation = () => {
  ...
  return (
    ...
    >
      ...
      <ul className={`navigation__link-section ${isMenuOpen ? "menu-open" : ""}`}>
        ...
        {/* Discover Orderly button visible always, moved into mobile menu on smaller screens */}
        <motion.button
      ...
      {/* Hamburger icon positioned on the right */}
