...
import { FaAtom, FaBee, FaRegClubs, FaPiggyBank } from 'react-icons/fa';
    ...
    >
      ...
      <div className="flex flex-col gap-6 lg:gap-12">
        ...
        <div className="grid w-full grid-flow-row justify-items-start gap-12 md:grid-cols-2 xl:gap-x-32">
          <IconCard icon={<FaAtom  className="size-8" />} />
          <IconCard icon={<FaBee  className="size-8 stroke-blue-700 [&>g>circle]:stroke-blue-300" />} />
          <IconCard icon={<FaRegClubs  className="size-8 stroke-blue-700" />} />
          <IconCard icon={<FaPiggyBank  className="size-8 stroke-blue-700" />} />
        </div>
      </div>
