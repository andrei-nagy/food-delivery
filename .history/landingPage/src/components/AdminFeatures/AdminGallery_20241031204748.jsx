...
function useFlip(ref) {
  ...
  }, [ref]); // Ensure this runs whenever `ref` changes
}
...
function useKeyDown(onKeyDown) {
  ...
  }, [onKeyDown]); // Include onKeyDown as a dependency
}
      ...
      <div className="gallery">
        {slides.map((slide, index) => {
          ...
          return (
            ...
            >
              <img data-flip src={slide.image} alt={slide.title} />
...
export default AdminGallery; // Ensure this is exported
