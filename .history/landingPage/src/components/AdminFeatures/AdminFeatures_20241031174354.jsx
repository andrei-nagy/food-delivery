...
import { AtomIcon, BeeIcon, ClubsIcon, PiggyBankIcon } from '@/icons';
    ...
    >
      ...
      <div className="flex flex-col gap-6 lg:gap-12">
        ...
        <div className="grid w-full grid-flow-row justify-items-start gap-12 md:grid-cols-2 xl:gap-x-32">
          <IconCard icon={<PiggyBankIcon className="size-8" />} />
          <IconCard icon={<AtomIcon className="size-8 stroke-blue-700 [&>g>circle]:stroke-blue-300" />} />
          <IconCard icon={<BeeIcon className="size-8 stroke-blue-700" />} />
          <IconCard icon={<ClubsIcon className="size-8 stroke-blue-700" />} />
        </div>
      </div>
