...
const AdminCustomizationPage = ({ url }) => {
    ...
    const fetchCustomizationData = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${url}/admin/personalization?restaurantId=ID`); // Trimite restaurantId ca parametru
    ...
    const addCustomizationData = async () => {
        ...
        try {
            await axios.post(`https://food-delivery-5mm6.onrender.com/api/admin/personalization/add`, customizationData); // Folosește ruta de adăugare
