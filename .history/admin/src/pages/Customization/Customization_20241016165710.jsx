...
const AddCustomization = ({ url, restaurantId }) => {
    ...
    useEffect(() => {
        const fetchCustomization = async () => {
            try {
                const response = await axios.get(`${url}/admin/personalization/get?restaurantId=${restaurantId}`);
                ...
                toast.error('Failed to fetch customization data.');
            }
        };
    ...
    const onSubmitHandler = async (event) => {
        ...
        formData.append('restaurantId', data.restaurantId); // Asigură-te că adaugi restaurantId
        ...
        try {
            const response = await axios.post(`${url}/admin/personalization/update`, formData);
            if (response.data.success) {
    ...
    return (
        <div className='add'>
            <form className='flex-col' onSubmit={onSubmitHandler}>
                ...
                <button type='submit' className='add-btn'>Update Customization</button>
            </form>
        </div>
    );
};
