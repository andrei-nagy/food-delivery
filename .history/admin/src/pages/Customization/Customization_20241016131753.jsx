...
const AdminCustomizationPage = () => {
    ...
    useEffect(() => {
        const fetchCustomizationData = async () => {
            setLoading(true);
            try {
                const response = await axios.get('/admin/personalize'); // Endpoint pentru obținerea personalizării
                setCustomizationData(response.data.data); // Populează datele
            } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('/personalize', customizationData); // Trimite datele către backend
