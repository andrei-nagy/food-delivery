...
const Customization = ({ url }) => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        // }
        if (image) {
            formData.append('image', image);  // Doar dacă `image` este selectată
        }
        ...
        <div className='add'>
            <form className='flex-col' onSubmit={onSubmitHandler}>
                <div className="add-img-upload flex-col">
                    ...
                    <label htmlFor="image">
                        <img src={image ? URL.createObjectURL(image) : data.image ? `${url}/images/${data.image}` : assets.upload_area} value={data.image} alt="" />
