...
const AccountsTable = () => {
    ...
    const [isEditing, setIsEditing] = useState(false); // Starea pentru editare
    const [currentAccount, setCurrentAccount] = useState(null); // Contul curent
    const [updatedAccount, setUpdatedAccount] = useState({ name: "", email: "", userRole: "", password: "" }); // Contul de actualizat
                        ...
                        <form onSubmit={handleUpdateAccount}>
                            ...
                            <div className='mb-4'>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setUpdatedAccount({ ...updatedAccount, password: e.target.value })}
                                    className='bg-gray-700 text-white rounded-md w-full p-2'
                                />
                            </div>
