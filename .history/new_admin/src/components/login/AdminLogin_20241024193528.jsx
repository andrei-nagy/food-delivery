...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        localStorage.setItem("userRole", response.data.role); // Salvează token-ul
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await axios.post(`${url}/admin/register`, { email, password, securityToken, role });
      if (response.data.success) {
