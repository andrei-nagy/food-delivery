...
const Login = () => {
  ...
  return (
    <section className="h-screen flex flex-col md:flex-row justify-center space-y-10 md:space-y-0 md:space-x-16 items-center my-2 mx-5 md:mx-0 md:my-0">
      ...
      <div className="md:w-1/3 max-w-sm text-center md:text-left space-y-4">
  <img
    src={assets.original_logo} // Schimbă URL-ul cu imaginea ta de logo
    alt="Orderly Logo"
    className="w-40 h-auto mx-auto md:mx-0" // Mărime logo ajustată și centrată
  />
