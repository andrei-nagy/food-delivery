        ...
        <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
          <div>
            <img
              ...
              alt="Logo"
            />
            <p className="leading-none px-2 inline-block text-sm text-gray-600 tracking-wide font-medium bg-white transform translate-y-1/2 text-center">Streamline Your Management, Maximize Your Impact</p>
          </div>
