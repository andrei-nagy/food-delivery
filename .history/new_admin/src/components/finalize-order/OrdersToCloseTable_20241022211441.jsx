                    ...
                    <tbody className='divide divide-gray-700'>
                        ...
                        {currentUsers.map((userOrder) => (
                            ...
                            >
                                ...
                                <button
    className="bg-blue-600 text-white font-semibold rounded-md px-4 py-2 hover:bg-blue-700 focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50 shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105"
