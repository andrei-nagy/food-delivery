            ...
            {isModalOpen && (
                <div className='fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50'>
                    ...
                    <button className='mt-4 bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700' onClick={handleCloseModal}>
                        ...
                        <table className='min-w-full divide-y divide-gray-700 mb-15'>
                            <thead>
                                <tr>
                                    <th className='px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider'>
                                        Order Number
                        ...
                        <button
                            className='bg-red-600 text-white px-4 py-2 rounded hover:bg-green-600'
                            onClick={() => handleAllPaymentStatusChange(true, selectedUserId, false)} // Exemplu de utilizare
                        >
                            Payment completed
                        </button>
                        <button className='mt-4 bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700' onClick={handleCloseModal}>
