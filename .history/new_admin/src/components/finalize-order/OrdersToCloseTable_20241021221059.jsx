...
const OrdersToCloseTable = () => {
    ...
    const handleCheckOrderClick = (order) => {
        const related = combinedOrders.filter(o => o.tableNo === order.tableNo); // Filtrează comenzile pe baza tableNo
                            ...
                            >
                                ...
                                <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-300'>
                                    <button
                                        ...
                                        onClick={() => handleCheckOrderClick(order)} // Pass order items to the function
                                    >
                                        Check order
                                    </button>
                                </td>
                ...
                >
                    <div className='bg-gray-800 p-6 rounded-lg shadow-lg'>
                        ...
                        <div className='text-gray-300'>
                            <p><strong>Order Number:</strong> {selectedOrder.orderNumber || "Unknown"}</p>
                            <p><strong>Payment:</strong> {selectedOrder.payment ? "Successful" : "Not paid"}</p>
                            ...
                            <p><strong>Date:</strong> {new Date(selectedOrder.date).toLocaleDateString('ro-RO') || "Unknown"}</p>
                        </div>

                        <h2 className='text-xl text-white mb-4 mt-6'>Order Items</h2>
                        <table className='min-w-full divide-y divide-gray-700'>
                            <thead>
                                <tr>
                                    <th className='px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider'>
