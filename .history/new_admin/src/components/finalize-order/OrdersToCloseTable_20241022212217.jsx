            ...
            {isModalOpen && (
                <div className='fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50'>
                    <div className='bg-gray-800 rounded-lg p-6 relative'> {/* Adăugat relative pentru a poziționa butonul Close */}
                        ...
                        <button
    className='absolute top-4 right-4 text-white w-10 h-10 rounded-full flex items-center justify-center hover:bg-red-700 border-2 border-red-700' // Buton Close
