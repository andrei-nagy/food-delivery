                    ...
                    <tbody className='divide divide-gray-700'>
                        ...
                        {currentUsers.map((userOrder) => (
                            ...
                            >
                                ...
                                <button
    className="bg-gray-800 text-white font-semibold rounded-md px-6 py-3 border-2 border-blue-600 hover:bg-gray-700 focus:ring-2 focus:ring-blue-400 focus:outline-none"
