...
>
    ...
    <option value="false">Inactive</option>
                                    ...
                                    <select
                                        onChange={(e) =>
                                            handleIsActiveChange(order.user?._id, e.target.value === "true") // Pass true/false based on selection
                                        }
                                        value={order.isActive ? "true" : "false"} // Set "true" for Active and "false" for Inactive
