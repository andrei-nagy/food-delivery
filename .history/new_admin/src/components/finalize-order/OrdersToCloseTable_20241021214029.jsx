...
const OrdersToCloseTable = () => {
    ...
    return (
        ...
        >
            ...
            <div className="bg-gray-800 bg-opacity-50 backdrop-blur max-w-2xl mx-4 sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto mt-16 bg-white shadow-xl rounded-lg text-gray-900">
            ...
            <div className="p-4 border-t mx-4 mt-2 flex ">
                <button className="w-1/2 block mx-auto rounded-full bg-gray-900 hover:shadow-lg font-semibold text-white px-6 py-2 mx-2">
                    Check orders
                </button>
                <button className="w-1/2 block mx-auto rounded-full bg-red-800 hover:shadow-lg font-semibold text-white px-6 py-2  ">
                    Close table
                </button>
            </div>
