...
const CategoryDistributionChart = () => {
 ...
 const topCategories = data.sort((a, b) => b.value - a.value).slice(0, 2);

 setProductData(topCategories);
    ...
    return (
        ...
        >
            <h2 className='text-lg font-medium mb-4 text-gray-100'>Category Sales Order</h2>
            <div className='h-80'>
