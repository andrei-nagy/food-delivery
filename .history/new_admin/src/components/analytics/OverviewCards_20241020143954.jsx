...
const OverviewCards = () => {
	...
	useEffect(() => {
		...
		const fetchUserCount = async () => {
			try {
				const response = await axios.get(`${url}/api/users/count`); // End-point pentru numărul de utilizatori
	...
	const overviewData = [
		...
		{ name: "Users", value: userCount !== null ? userCount.toLocaleString() : "Loading...", change: 8.3, icon: Users }, // Afișăm numărul de utilizatori dinamic
