...
const targetData = [
	{ month: "Jan", target: 3800 },
	{ month: "Feb", target: 3200 },
	{ month: "Mar", target: 4500 },
	{ month: "Apr", target: 4200 },
	{ month: "May", target: 5500 },
	{ month: "Jun", target: 5800 },
	{ month: "Jul", target: 6500 },
	{ month: "Aug", target: 6500 },
	{ month: "Sep", target: 6200 },
	{ month: "Oct", target: 6800 },
	{ month: "Nov", target: 7000 },
	{ month: "Dec", target: 7500 },
];
		...
		const fetchRevenueData = async () => {
			try {
				...
				if (response.data.success) {
					...
					console.log(revenueByMonth); // Verifică veniturile grupate pe lună
