            ...
            <div className="bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md text-center">
                ...
                {tableNo && (
                   ...
                   >
                        ...
                        <p className="mt-4 font-semibold text-white text-lg restaurant_name text-[24px] font-raleway" >
                               {data.restaurantName}
                            </p>
                        {/* QR Code */}
                        ...
                        <p className="mt-2 text-gray-600 text-center italic font-raleway">
