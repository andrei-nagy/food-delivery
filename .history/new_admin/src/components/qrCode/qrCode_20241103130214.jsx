        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-gray-100 p-6">
            <div className="bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md text-center">
                ...
                {tableNo && (
                    <div
                        id="qr-container"
                        className="mt-8 bg-white p-6 rounded-lg shadow-md flex flex-col items-center transition-transform transform hover:scale-105"
                    >
                        {/* Logo-ul restaurantului */}
                        <div className="mb-4">
                            <img
                                src={typeof image === 'string' ? `${url}/images/` + image : null} // Asigură-te că acest path este corect
                                alt="Restaurant Logo"
                        ...
                        <QRCode
                            ...
                            logoImage={typeof image === 'string' ? `${url}/images/` + image : null}
                            size={180}
                            className="rounded-md shadow-lg" // Adăugați umbră pentru un efect 3D
                        />
