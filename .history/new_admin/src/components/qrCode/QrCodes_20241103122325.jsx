...
const QrCodes = () => {
    ...
    const downloadQrImage = (qrImage) => {
        const link = document.createElement('a');
        link.href = qrImage;
        link.download = `QR_Code_Table_${new Date().getTime()}.png`; // Use a timestamp for unique filename
                            ...
                            >
                                ...
                                <td className='px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-100'>
                                    <button
                                        ...
                                        onClick={() => downloadQrImage(order.qrImage)} // Download the image using the qrImage field
                                    >
                                        Download
                                    </button>
                                </td>
