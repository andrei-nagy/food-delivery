                ...
                {tableNo && (
                    ...
                    >
                        <QRCode
                            ...
                            className="rounded"
                        />
                        <p className="mt-4 font-semibold text-gray-700" style={{ marginBottom: '10px' }}> {/* Add margin-bottom here */}
                ...
                {qrImage && (
                    <div className="mt-8">
                        ...
                        <img
                            ...
                            style={{ width: '300px', height: 'auto' }} // Adjust size here for better visibility
                        />
                        <button
