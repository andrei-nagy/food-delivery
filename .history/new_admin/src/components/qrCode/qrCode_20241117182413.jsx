                ...
                {tableNo && (
                   ...
                   >
                        ...
                        <p className="mt-4 font-semibold text-gray-700 text-lg font-raleway">
                            QR Code for <span className="text-white font-bold">Table {tableNo}</span> {/* Evidențiază Table No */}
                        </p>
                        ...
                        <p className="mt-2 text-gray-600 text-center italic font-raleway font-semibold font-tangerine text-[24px]">
