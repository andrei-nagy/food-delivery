    ...
    try {
        ...
        if (response.data.success && Array.isArray(response.data.data)) {
            ...
            const sortedOrders = filteredOrders.sort((a, b) => {
                const tableNumberA = a.tableNumber ? Number(a.tableNumber) : 0; // Asigură-te că tableNumber este un număr
                const tableNumberB = b.tableNumber ? Number(b.tableNumber) : 0; // Asigură-te că orderNumber este un număr
