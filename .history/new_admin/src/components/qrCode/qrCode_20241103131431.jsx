            ...
            <div className="bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md text-center">
                ...
                {tableNo && (
                    ...
                    >
                        ...
                        <div className="mb-4">
                            <img
                                src={image ? `${url}/images/` + image : {assets.original_olog}} // Asigură-te că folosești un path corect
                                alt="Restaurant Logo"
                        ...
                        <p className="mt-4 font-semibold text-gray-700 text-lg">
                            QR Code for <span className="text-blue-600 font-bold">Table No. {tableNo}</span> {/* Evidențiază Table No */}
                        </p>
