            ...
            <div className="lg:col-span-2 p-4 py-6 rounded-lg bg-gray-100 dark:bg-gray-800 md:p-8">
                <form>
                    ...
                    <div className="mt-4">
                        ...
                        <select className="block w-full px-5 py-2.5 mt-2 text-gray-700 bg-white border border-gray-200 rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40">
