    ...
    return (
        <section className="bg-white dark:bg-gray-900 rounded-lg">
            <div className="container px-6 py-12 mx-auto">
                <div>
                    <p className="font-medium text-blue-500 dark:text-blue-400">Submit a Support Ticket</p>
                    <h1 className="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">Chat to our friendly team</h1>
                    <p className="mt-3 text-gray-500 dark:text-gray-400">Having trouble with the Orderly app? Fill out the form below, and our team will get back to you as soon as possible.</p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
                    ...
                    <div className="lg:col-span-2 p-4 py-6 rounded-lg bg-gray-50 dark:bg-gray-800 md:p-8">
                        <form>
                            ...
                            <div className="mt-4">
                                ...
                                <input type="email" placeholder="We’ll use this email to keep you updated on the status of your ticket." className="block w-full px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                            </div>

                            <div className="w-full mt-4">
                                <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200">Issue Description</label>
                            ...
                            <div className="w-full mt-4">
                                ...
                                <select className="bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="" id="">
