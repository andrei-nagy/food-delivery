    ...
    const fetchList = async () => {
        ...
        if (response.data.success) {
            ...
            if (JSON.stringify(newList) !== JSON.stringify(list)) {
                const currentRequestCount = newList.filter(item => item.status === 'Pending').length;

                // Dacă numărul cererilor a crescut, salvează cererile noi
                ...
                setList(newList);
                setPreviousRequestCount(currentRequestCount); // Actualizează numărul cererilor anterioare
            }
        } else {
            toast.error("Error");
        }
