                    ...
                    <tbody className='divide-y divide-gray-700'>
                        {currentRequests.map((item) => (
                            ...
                            >
                                <td className='px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-100'>
                                    <div className='flex items-center'>
                                        <div className='flex-shrink-0 h-10 w-10'>
                                            <div className='h-10 w-10 rounded-lg bg-gradient-to-r from-purple-400 to-blue-500 flex items-center justify-center text-white font-semibold'>
                                                {item.tableNo}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <td className='px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-100'>
                                    <span className='bg-gray-800 text-white font-semibold rounded-md px-6 py-3 border-2 border-blue-500 hover:bg-gray-700 focus:ring-2 focus:ring-blue-100 focus:outline-none'>
                                        {item.action}
                                    </span>
                                </td>
