                    ...
                    <tbody className='divide-y divide-gray-700'>
                        {currentRequests.map((item) => (
                            ...
                            >
                                ...
                                <td className='px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-100'>
                                    <span className='px-4 py-1 inline-flex text-sm font-medium text-gray-100 leading-5 font-semibold rounded-lg border-2 border-gray-700  text-blue-100'>
                                        {item.action}
                                    </span>
                                </td>
                                ...
                                <td className='px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-100'>
                                    <select
                                        ...
                                        className={`px-4 py-1 inline-flextext-sm font-medium text-gray-100 font-semibold rounded-lg ${
                                            item.status === "Active" ? "bg-green-800 text-green-100" : "border-2 border-gray-700"
                                        }`}
                                    >
