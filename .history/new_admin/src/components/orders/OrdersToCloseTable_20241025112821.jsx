...
const OrdersToCloseTable = () => {
    ...
    const handleAllPaymentStatusChange = async (paymentStatus, userId, newIsActiveStatus) => {
        ...
        try {
            ...
            if (success) {
                toast.success("Payment status updated successfully for all orders.", {theme: "dark"});
                ...
                toast.error("Failed to update payment status for some orders.", {theme: "dark"});
            }
        } catch (error) {
    ...
    const handlePaymentStatusChange = async (orderId, paymentStatus) => {
        try {
            ...
            if (response.data.success) {
                ...
                toast.success("Payment status updated successfully.", {theme: "dark"});
        ...
        >
            ...
            {isModalOpen && (
                <div className='fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50'>
                    <div className='bg-gray-800 rounded-lg p-6 relative'> {/* Adăugat relative pentru a poziționa butonul Close */}
                        ...
                        <div className='flex justify-center mt-4'>
                            <button
                                className='bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700' // Buton Order completed
