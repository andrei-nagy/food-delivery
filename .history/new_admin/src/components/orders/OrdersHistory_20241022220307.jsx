...
const fetchOrders = async () => {
    ...
    return (
        <motion.div
        className={`bg-opacity-50 backdrop-blur-md shadow-lg rounded-xl p-6 border border-gray-700 mb-8 ${isDarkMode ? 'bg-gray-800' : ''}`} // Adaugă clasa doar când isDarkMode este true
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.4 }}
        style={{
            backgroundColor: isDarkMode ? 'transparent' : '#ffffff', // Fundal alb pentru modul normal
            color: '#4B5563', // Textul de culoare gri închis
            borderColor: '#D1D5DB', // Culoarea bordurii
        }}
        >
