...
const CustomizationPage = () => {
    ...
    // State local pentru gestionarea inputurilor
    const [localSchedule, setLocalSchedule] = useState({
        weekdays: { open: data.openingHours?.weekdays?.open || "", close: data.openingHours?.weekdays?.close || "" },
        saturday: { open: data.openingHours?.saturday?.open || "", close: data.openingHours?.saturday?.close || "" },
        sunday: { open: data.openingHours?.sunday?.open || "", close: data.openingHours?.sunday?.close || "" },
    });
    ...
    const handleTimeChange = (e, dayType) => {
            ...
            <div className='overflow-x-auto'>
                ...
                <form className="bg-gray-800 rounded-lg shadow-md p-6 flex flex-col space-y-4'" onSubmit={onSubmitHandler}>
                    ...
                    <input
                        type="time"
                        name="open"
                        value={localSchedule.weekdays.open}
