...
const CustomizationPage = () => {
    ...
    const onImageChangeHandler = (event) => {
        // Verify if the selected file is a valid image
    ...
    const onSubmitHandler = async (event) => {
        ...
        // Use selected image if exists, otherwise use existing image
        if (image) { 
        ...
        try {
            ...
            if (response.data.success) {
                ...
                setImage(null); // Reset image here if needed
            ...
            <div className='overflow-x-auto'>
                <form className='bg-gray-50 rounded-lg shadow-md p-6 flex flex-col space-y-4' onSubmit={onSubmitHandler}>
                    <div className="add-img-upload flex-col items-center mb-4">
                            ...
                            <div className='w-full max-w-xs h-40 border-2 border-dashed border-gray-300 rounded flex items-center justify-center'>
                                {image ? (
                                    ...
                                    <img
                                        ...
                                        className="mb-2 w-32 h-32 object-contain rounded" // Adjust dimensions as needed
                                    />
                                ) : (
                        ...
                        <input 
                            onChange={onImageChangeHandler} // Change handler for image
                            type="file" 
                            id='image' 
                            name="image" 
                            hidden 
