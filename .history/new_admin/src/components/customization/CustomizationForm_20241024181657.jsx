            ...
            <div classname="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-600 dark:bg-gray-700 mb-6">
              <div classname="flex justify-between items-center mb-3">
                ...
                <label classname="inline-flex items-center cursor-pointer">
                  <input type="checkbox" defaultvalue name="business-hours" classname="sr-only peer" />
              ...
              <div classname="pb-6 mb-6 border-b border-gray-200 dark:border-gray-700">
                <label htmlfor="timezones" classname="flex items-center mb-2 text-sm font-medium text-gray-900 dark:text-white">
                  ...
                  <div id="tooltip-timezone" role="tooltip" classname="inline-block absolute invisible z-10 py-2 px-3 max-w-sm text-xs font-normal text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                    ...
                    <select id="timezones" name="timezone" classname="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                  ...
                  <div classname="mb-6">
                    <div classname="flex items-center justify-between">
                      <div classname="flex items-center min-w-[4rem]">
                        <input defaultchecked id="monday" name="days" type="checkbox" defaultvalue="monday" classname="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                        <label htmlfor="monday" classname="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Mon
                        </label>
                      </div>
                      <div classname="w-full max-w-[7rem]">
                        ...
                        <div classname="relative">
                          ...
                          <input type="time" id="start-time-monday" name="start-time-monday" classname="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" min="09:00" max="18:00" defaultvalue="00:00" required />
                        </div>
                      </div>
                      <div classname="w-full max-w-[7rem]">
                        ...
                        <div classname="relative">
                          ...
                          <input type="time" id="end-time-monday" name="end-time-monday" classname="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" min="09:00" max="18:00" defaultvalue="00:00" required />
                        </div>
                      </div>
                      <div>
                        <button type="button" classname="inline-flex items-center p-1.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100">
                  ...
                  <div classname="mb-6">
                    <div classname="flex items-center justify-between">
                      <div classname="flex items-center min-w-[4rem]">
                        <input id="tuesday" name="days" type="checkbox" defaultvalue="tuesday" classname="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                        <label htmlfor="tuesday" classname="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Tue
                        </label>
                      </div>
                      <div classname="w-full max-w-[7rem]">
                        ...
                        <div classname="relative">
                          ...
                          <input type="time" id="start-time-tuesday" name="start-time-tuesday" classname="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" min="09:00" max="18:00" defaultvalue="00:00" required />
                        </div>
                      </div>
                      <div classname="w-full max-w-[7rem]">
                        ...
                        <div classname="relative">
                          ...
                          <input type="time" id="end-time-tuesday" name="end-time-tuesday" classname="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" min="09:00" max="18:00" defaultvalue="00:00" required />
                        </div>
                      </div>
                      <div>
                        <button type="button" classname="inline-flex items-center p-1.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100">
                  ...
                  <div classname="mb-6">
                    <div classname="flex items-center justify-between">
                      <div classname="flex items-center min-w-[4rem]">
                        <input defaultchecked id="wednesday" name="days" type="checkbox" defaultvalue="wednesday" classname="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                        <label htmlfor="wednesday" classname="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Wed
                        </label>
                      </div>
                      <div classname="w-full max-w-[7rem]">
                        ...
                        <div classname="relative">
                          ...
                          <input type="time" id="start-time-wednesday" name="start-time-wednesday" classname="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" min="09:00" max="18:00" defaultvalue="00:00" required />
                        </div>
                      </div>
                      <div classname="w-full max-w-[7rem]">
                        ...
                        <div classname="relative">
                          ...
                          <input type="time" id="end-time-wednesday" name="end-time-wednesday" classname="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" min="09:00" max="18:00" defaultvalue="00:00" required />
                        </div>
                      </div>
                      <div>
                        <button type="button" classname="inline-flex items-center p-1.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100">
                  ...
                  <div classname="mb-6">
                    <div classname="flex items-center justify-between">
                      <div classname="flex items-center min-w-[4rem]">
                        <input id="thursday" name="days" type="checkbox" defaultvalue="thursday" classname="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                        <label htmlfor="thursday" classname="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Thu
                        </label>
                      </div>
                      <div classname="w-full max-w-[7rem]">
                        ...
                        <div classname="relative">
                          ...
                          <input type="time" id="start-time-thursday" name="start-time-thursday" classname="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" min="09:00" max="18:00" defaultvalue="00:00" required />
                        </div>
                      </div>
                      <div classname="w-full max-w-[7rem]">
                        ...
                        <div classname="relative">
                          ...
                          <input type="time" id="end-time-thursday" name="end-time-thursday" classname="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" min="09:00" max="18:00" defaultvalue="00:00" required />
                        </div>
                      </div>
                      <div>
                        <button type="button" classname="inline-flex items-center p-1.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100">
                  ...
                  <div classname="mb-6">
                    <div classname="flex items-center justify-between">
                      <div classname="flex items-center min-w-[4rem]">
                        <input id="friday" name="days" type="checkbox" defaultvalue="friday" classname="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                        <label htmlfor="friday" classname="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Fri
                        </label>
                      </div>
                      <div classname="w-full max-w-[7rem]">
                        ...
                        <div classname="relative">
                          ...
                          <input type="time" id="start-time-friday" name="start-time-friday" classname="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" min="09:00" max="18:00" defaultvalue="00:00" required />
                        </div>
                      </div>
                      <div classname="w-full max-w-[7rem]">
                        ...
                        <div classname="relative">
                          ...
                          <input type="time" id="end-time-friday" name="end-time-friday" classname="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" min="09:00" max="18:00" defaultvalue="00:00" required />
                        </div>
                      </div>
                      <div>
                        <button type="button" classname="inline-flex items-center p-1.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100">
