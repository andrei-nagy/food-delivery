                ...
                <form className="bg-gray-800 rounded-lg shadow-md p-6 flex flex-col space-y-4'" onSubmit={onSubmitHandler}>
                    ...
                    <div className="relative z-0 w-full mb-5 group">
                        <input type="text"
                            ...
                            name="restaurantName"
                            id="restaurantName"
                            className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-800 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
