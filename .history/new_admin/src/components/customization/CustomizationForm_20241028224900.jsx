        ...
        try {
            ...
            if (customizationData.openingHours) {
                ...
                setSchedule((prevSchedule) => ({
                    ...prevSchedule,
                    weekdays: {
                        open: parsedOpeningHours.weekdays?.open || "",
                        close: parsedOpeningHours.weekdays?.close || "",
                    },
                    saturday: {
                        open: parsedOpeningHours.saturday?.open || "",
                        close: parsedOpeningHours.saturday?.close || "",
                    },
                    sunday: {
                        open: parsedOpeningHours.sunday?.open || "",
                        close: parsedOpeningHours.sunday?.close || "",
                    }
                }));
            }
            } else {
