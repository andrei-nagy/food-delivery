                    ...
                    <div className="add-img-upload flex-col items-center mb-4">
                        ...
                        <label htmlFor="image" className='cursor-pointer'>
                            <div className='w-full max-w-xs h-40 border-2 border-dashed border-gray-300 rounded flex items-center justify-center'>
                                {image ? (
                                    <img src={URL.createObjectURL(image)} alt="Category preview" className='object-cover w-full h-full rounded' name="image" />
                                ) : (
                                    <img src={assets.upload_area} alt="Upload area" className='object-cover w-full h-full rounded' name="image" />
                                )}
                            </div>
                        </label>
