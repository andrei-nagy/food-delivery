    ...
    const onSubmitHandler = async (event) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                // Do not reset image here if no new image was selected
                    ...
                    <div className="add-img-upload flex-col items-center mb-4">
                        ...
                        <label htmlFor="image" className='cursor-pointer'>
                            <div className='w-full max-w-xs h-40 border-2 border-dashed border-gray-300 rounded flex items-center justify-center'>
                                {image ? (
                                    <img src={URL.createObjectURL(image)} alt="Category preview" className='object-contain w-full h-full rounded' />
                                ) : data.image ? (
                                    <img
