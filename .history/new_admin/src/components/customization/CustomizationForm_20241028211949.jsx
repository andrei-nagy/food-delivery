...
const CustomizationPage = () => {
    ...
    <input
        ...
        className="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-10 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
        required
        step="600"
    />
    <button
        ...
        className="absolute right-2 top-8 transform -translate-y-1/2 text-gray-500 hover:text-gray-800 dark:hover:text-white"
    >
        &#x2715;
    </button>
</div>
