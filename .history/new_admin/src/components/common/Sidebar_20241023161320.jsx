...
const SIDEBAR_ITEMS = [
	...
	{ name: "Submit a ticket", icon: HelpCircle, color: "#6EE7B7", href: "/help" },
];
			...
			>
				<div className="h-full bg-gray-800 bg-opacity-50 backdrop-blur-md p-4 flex flex-col border-r border-gray-700">
												...
												>
													...
													<Link to="/close-order">
														<motion.div
															...
															style={{
																backgroundColor:
																	location.pathname === "/close-order" ? "rgba(255, 255, 255, 0.1)" : "transparent", // evidențiere activă pentru Orders History
															}}
											...
											>
												<Link to="/analytics">
													<motion.div
														...
														style={{
															backgroundColor:
																location.pathname === "/analytics" ? "rgba(255, 255, 255, 0.1)" : "transparent", // evidențiere activă pentru Orders
														}}
													>
														Analytics
													</motion.div>
												...
												<Link to="/sales">
													<motion.div
														...
														style={{
															backgroundColor:
																location.pathname === "/sales" ? "rgba(255, 255, 255, 0.1)" : "transparent", // evidențiere activă pentru Orders History
														}}
													>
														Sales
													</motion.div>
					...
					{localStorage.getItem("authToken") && ( // Verifică dacă authToken există
						<motion.button
							className="bg-red-600 hover:bg-red-700 text-white font-semibold rounded-md px-6 py-3 border-2 border-gray-700 hover:bg-gray-700 focus:ring-2 focus:ring-blue-100 focus:outline-none"
