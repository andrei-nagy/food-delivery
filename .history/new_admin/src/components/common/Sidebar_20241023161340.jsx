			...
			>
				<div className="h-full bg-gray-800 bg-opacity-50 backdrop-blur-md p-4 flex flex-col border-r border-gray-700">
					...
					{localStorage.getItem("authToken") && ( // Verifică dacă authToken există
						<motion.button
							className="hover:bg-red-700 text-white font-semibold rounded-md px-6 py-3 border-2 border-red-700 hover:bg-gray-700 focus:ring-2 focus:ring-blue-100 focus:outline-none"
