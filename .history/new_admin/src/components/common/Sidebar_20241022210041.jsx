...
{localStorage.getItem("authToken") && ( // Verifică dacă authToken există
	...
	>
		{/* Pe ecrane mici (mobile) va apărea doar X, pe ecrane mai mari va apărea Logout */}
		<span className="block sm:hidden">X</span> {/* Se va afișa doar pe mobile */}
		<span className="hidden sm:block">Logout</span> {/* Se va afișa pe ecrane mai mari */}
	</motion.button>
)}
