...
const ProductsTable = () => {
    ...
    const handleAddProduct = async (event) => {
        ...
        // Append boolean values only if they are defined
        if (updatedProduct.isBestSeller !== "") {
            formData.append("isBestSeller", updatedProduct.isBestSeller === "true");
        }
    
        if (updatedProduct.isNewAdded !== "") {
            formData.append("isNewAdded", updatedProduct.isNewAdded === "true");
        }
    
        if (updatedProduct.isVegan !== "") {
            formData.append("isVegan", updatedProduct.isVegan === "true");
        }
