                    ...
                    <div className="relative p-4 w-full max-w-md max-h-full">
                        ...
                        <div className="flex items-center">
                            <input
                                ...
                                onChange={(e) => setUpdatedProduct({ ...updatedProduct, isBestSeller: e.target.value })}
                        ...
                        <div className="flex items-center">
                            <input
                                ...
                                onChange={(e) => setUpdatedProduct({ ...updatedProduct, isNewAdded: e.target.value })}
                                className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                            />
                        ...
                        <div className="flex items-center">
                            <input
                                ...
                                onChange={(e) => setUpdatedProduct({ ...updatedProduct, isVegan: e.target.value })}
                                className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                            />
