...
const ProductsTable = () => {
    ...
    const handleAddProduct = async (event) => {
        ...
        formData.append("isBestSeller", updatedProduct.isBestSeller == "true" ? true : false);
        formData.append("isNewAdded", updatedProduct.isNewAdded == "true" ? true : false);
        formData.append("isVegan", updatedProduct.isVegan == "true" ? true : false);
