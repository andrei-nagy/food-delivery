                            ...
                            <form className="p-4 md:p-5" onSubmit={handleAddProduct}>
                                <div className="grid gap-4 mb-4 grid-cols-2">
                                    <div className="col-span-2">
                                        <label  className="block mb-2 text-sm font-medium text-gray-900 dark:text-white cursor-pointer">Upload image</label>
                                        <div htmlFor="image" className='w-40 h-40 border-2 border-dashed border-gray-300 rounded flex items-center justify-center cursor-pointer'>
                                            {image ? (
