...
const SalesPage = () => {
	...
	return (
		<div className='flex-1 overflow-auto relative z-10'>
			...
			<PDFButton apiUrl="http://localhost:4000/api/order/list" documentTitle="Sales Raport"                     className="bg-gray-800 text-white font-semibold rounded-md px-6 py-3 border-2 border-gray-700 hover:bg-gray-700 focus:ring-2 focus:ring-blue-100 focus:outline-none"
 />
			<button
