...
const EditProductModal = ({ isOpen, onClose, product, onProductUpdated }) => {
    ...
    useEffect(() => {
        if (product) {
            // Asigură-te că toate câmpurile nutriționale sunt preluate corect
            const productNutrition = product.nutrition || {};
            const productPreparation = product.preparation || {};
            const productDietaryInfo = product.dietaryInfo || {};
            ...
            setUpdatedProduct({
                ...
                preparation: {
                    cookingTime: productPreparation.cookingTime || "",
                    spiceLevel: productPreparation.spiceLevel || "",
                    servingSize: productPreparation.servingSize || "",
                    difficulty: productPreparation.difficulty || ""
                },
                dietaryInfo: {
                    isGlutenFree: productDietaryInfo.isGlutenFree || false,
                    isDairyFree: productDietaryInfo.isDairyFree || false,
                    isVegetarian: productDietaryInfo.isVegetarian || false,
                    isSpicy: productDietaryInfo.isSpicy || false,
                    containsNuts: productDietaryInfo.containsNuts || false
                },
    ...
    const handleNutritionChange = (newNutrition) => {
        console.log("🔄 Updating nutrition:", newNutrition);
    ...
    const handlePreparationChange = (newPreparation) => {
        console.log("🔄 Updating preparation:", newPreparation);
        setUpdatedProduct(prev => ({
            ...prev,
    ...
    const handleDietaryInfoChange = (newDietaryInfo) => {
        console.log("🔄 Updating dietaryInfo:", newDietaryInfo);
        setUpdatedProduct(prev => ({
            ...prev,
                        ...
                        <div className="flex flex-col md:flex-row gap-6">
                            ...
                            <div className="space-y-2 flex-1">
                                ...
                                <ImageUploadSection 
                                    ...
                                    onImageChange={(file) => setUpdatedProduct(prev => ({ ...prev, image: file }))} 
                                />
                            </div>
                        </div>
                    </div>
