...
const Header = ({ title, onSearch, showNotifications = true }) => {
	...
	const handleSearchSubmit = (e) => {
		e.preventDefault();
		if (searchQuery.trim()) {
			// Nu mai închide search-ul, doar filtrează
			// Dacă există exact un rezultat, navighează direct la el
					...
					<>
						...
						>
							<div className="h-full flex flex-col">
								...
								{/* Search Bar pentru Meniu (în meniul mobile) */}
								<div className="p-3 border-b border-gray-800">
									<div className="relative">
										...
										<input
											...
											value={searchQuery}
											onChange={handleMenuSearch}
											className="w-full pl-9 pr-8 py-2 bg-gray-800 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent"
											autoFocus
										/>
										{searchQuery && (
											<button
